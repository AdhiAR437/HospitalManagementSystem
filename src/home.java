...
public class home extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 170, 350, 70));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 330, 350, 70));
        ...
        getContentPane().add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 490, 350, 70));
        ...
        getContentPane().add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 670, 350, 70));
        ...
        jButton6.setPreferredSize(new java.awt.Dimension(250, 60));
        jButton6.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton6ActionPerformed(evt);
            }
        });
        getContentPane().add(jButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 830, 350, 70));

        jButton7.setBackground(new java.awt.Color(255, 255, 255));
        jButton7.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jButton7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/exit.png"))); // NOI18N
        jButton7.setText("Logout");
        jButton7.setPreferredSize(new java.awt.Dimension(250, 60));
        jButton7.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton7ActionPerformed(evt);
            }
        });
        getContentPane().add(jButton7, new org.netbeans.lib.awtextra.AbsoluteConstraints(1700, 990, 200, 70));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/homeFINALI$E.jpg"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
         ...
         if(i==0)
        {
            ...
            jButton3.setLocation(460,30);
            jButton4.setLocation(770,30); 
            jButton5.setLocation(1080,30);
            jButton6.setLocation(1390,30);
           // jButton7.setLocation(1700,30);
               i=1;
        }
        else
        {
             jButton2.setLocation(10,170);
             jButton3.setLocation(10,320);
             jButton4.setLocation(10,470); 
             jButton5.setLocation(10,620);
             jButton6.setLocation(10,770);
            // jButton7.setLocation(10,920);
               i=0;
        }
